            ...
            <div className="flex flex-wrap">
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 text-center inline-flex items-center justify-center w-20 h-20 mb-5 shadow-lg rounded-full bg-white">
                      <Image width={500} height={500} layout="responsive" src="/images/icon4.png" alt="Freight Forwarding Icon" />
                    </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 text-center inline-flex items-center justify-center w-20 h-20 mb-5 shadow-lg rounded-full bg-lightBlue-400">
                      <Image width={500} height={500} layout="responsive" src="/images/icon5.png" alt="Inventory Management Icon" />
                    </div>
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 text-center inline-flex items-center justify-center w-20 h-20 mb-5 shadow-lg rounded-full bg-white">
                      <Image width={500} height={500} layout="responsive" src="/images/icon1.png" alt="Warehousing Solutions Icon" />
                    </div>
