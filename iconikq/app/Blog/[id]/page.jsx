  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content={`Read about ${blog.title}, discussing its impact on logistics and global trade.`}
        />
        ...
        <meta
          property="og:url"
          content={`https://yourwebsite.com/blog/${id}`}
        />
      </Head>
        ...
        <main className="mt-12">
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-12">
            ...
            <div className="lg:w-3/4 px-4 lg:px-0 mb-12 lg:mb-0">
              {[blog.passage1, blog.passage2, blog.passage3].map(
                (passage, idx) => (
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition duration-300 ease-in-out">
                <div className="flex flex-wrap flex-col justify-center items-center mb-6">
                  <Image
                    loading="lazy"
                    alt={
                      blog.id % 2 === 0 ? "Drusti Ruparel" : "Mr. Parth Ruparel"
                    }
                    width={120}
                    height={120}
                    layout="intrinsic"
                ...
                <p className="text-gray-700 mb-4 text-lg leading-relaxed text-justify">
                  {blog.id % 2 === 0 ? "Drusti Ruparel" : "Mr. Parth Ruparel"}{" "}
                  is a logistics expert dedicated to providing efficient and
                  customized solutions, ensuring timely and secure deliveries
                  globally.
                </p>
                <Button
                  className="mx-auto"
