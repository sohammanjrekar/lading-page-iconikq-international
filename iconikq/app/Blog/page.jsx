      ...
      <div className="max-w-7xl mx-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16">
        ...
        <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
          {sortedBlogData.slice(1, 6).map((post, index) => (
            <div
              key={post.id}
              className="flex bg-mylight rounded-lg shadow-xl flex-col items-start col-span-12 sm:col-span-6 xl:col-span-4 space-y-3"
            >
