            ...
            <figure className="relative isolate">
              ...
              <blockquote className="mt-6 text-xl font-semibold leading-8 text-white">
                <p>
                  ...
                  happens." "The journey of a thousand miles begins with one
                  step." "The only true wisdom is in knowing you know nothing."
        ...
        <div>
          <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
            ...
            <div className="max-w-xl">
              <p className="mt-6">
                You won't ever have a peaceful mind unless you have a peace ful
                life and equal times you have a time with your religion then
                time for fun then time for work and study.
              </p>
              <p className="mt-8">
                You want to have a peaceful day try ignoring problems that are
                blamed on you but you are sure you didn't do the mistake.
              </p>
              <p className="mt-8">
                Try dividing your life days into equal times and do every thing
                on it's time.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 flex">
            ...
            >
              Learn more about our company <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
      </div>
