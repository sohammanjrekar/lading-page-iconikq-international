              ...
              <div className="relative p-8 space-y-8 flex flex-wrap justify-center items-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-center text-myblue">
                    ...
                    latest industry trends and regulations. Thats why we are
                    commited to always learning and improving our services.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8 flex flex-wrap justify-center items-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-center text-myblue">
                    From real-time tracking and automated processes to digital
                    documentation and advanced analytics, these technological
                    advancements are revolutionizing the logistics industry.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative p-8 space-y-8 flex flex-wrap justify-center items-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-myblue text-center">
                    When it comes to frieght forwarding , safety and quality are
                    essential considerations.At our company, we palce a strong
                    emphasis on both to ensure that ourcustomers receive thier
            ...
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8 flex flex-wrap justify-center items-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-myblue text-center">
                    We are commited to minimizing our impact on the environment.
                    we believe that it is our responsibility to contribute to a
