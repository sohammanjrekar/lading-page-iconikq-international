  ...
  <section className="bg-white bg-gray-900">
    <div className="container px-6 py-10 mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
        <div className="p-8 space-y-3 border-2 border-blue-400 border-blue-300 rounded-xl">
          ...
          <a
            href="#"
            className="inline-flex p-2 text-blue-500 capitalize transition-colors duration-200 transform bg-blue-100 rounded-full bg-blue-500 text-white hover:underline hover:text-blue-600 hover:text-blue-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 h-6"
