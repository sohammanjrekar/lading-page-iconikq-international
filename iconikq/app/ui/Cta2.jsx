  ...
  return (
    <>
      ...
      <div className="mx-auto my-24 flex h-52 w-[780px] flex-col rounded-lg bg-white font-serif text-black shadow-xl">
        <div className="mt-4">
          <h1 className="mx-11 my-1 font-bold text-[20px] text-gray-600">
            Get more updates...
          </h1>
        </div>
        <div className="mx-11 mb-4 text-sm text-gray-500">
          <p>
            ...
            Flowbite? Sign up for our newsletter and you&apos;ll be among the
        ...
        <div className="relative flex justify-center space-x-3">
          ...
          <input
            className="w-[570px] rounded-lg p-2 hover:outline-blue-400"
            type="email"
            placeholder="Your email address"
          />
          <button className="w-32 rounded-lg border bg-blue-700 font-medium text-white hover:bg-blue-800">
            Subscribe
          </button>
        </div>
        <div>
