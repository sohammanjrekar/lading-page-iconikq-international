...
const ContactPage = () => {
  ...
  const addContact = async (e) => {
    ...
    if (error) {
      ...
      setSuccessMessage(
        "Thank you for getting in touch! We will respond soon."
      );
      setErrorMessage("");
      setName("");
      setEmail("");
          ...
          <div className="flex flex-wrap lg:justify-between -mx-4">
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 lg:mb-0">
                <span className="block mb-4 text-xl text-myred  font-semibold">
                  Contact Us
                </span>
                ...
                <div className="flex items-center mt-8 text-myblue">
                  <Image
                    src={
                      "https://res.cloudinary.com/mybazaar/image/upload/v1730803511/iconikq/location_dw9sc6.png"
                    }
                    alt="address"
                    height={50}
                    width={50}
                  ...
                  <div className="text-lg  tracking-wide font-medium w-full mx-3">
                    704/705, Filix, Opposite Asian Paints, LBS Marg, Bhandup
                    West, Mumbai – 400078
                  </div>
                </div>
                ...
                <div className="flex items-center mt-4 text-myblue">
                  <Image
                    src={
                      "https://res.cloudinary.com/mybazaar/image/upload/v1730803511/iconikq/call_ugpana.png"
                    }
                    alt="phone"
                    height={50}
                    width={50}
                ...
                <div className="flex items-center mt-2 text-myblue">
                  <Image
                    src={
                      "https://res.cloudinary.com/mybazaar/image/upload/v1730386190/iconikq/email_s9ybuk.png"
                    }
                    alt="email"
                    height={50}
                    width={50}
