...
const Services = () => {
  ...
  const cardData = [
    ...
    },
    {
      ...
      description:
        "Iconikq International offers expert inventory management services to streamline your supply chain. Our solutions ensure optimal stock levels, reduce costs, and enhance order accuracy.",
    ...
    },
    {
      ...
      description:
        "Iconikq International provides fast and reliable sea and air customs clearance. Our expert team ensures smooth processing with services like import/export clearance, documentation, shipment examination, and warehousing.",
    ...
    },
    {
      ...
      description:
        "We offer expert supply chain consulting services, optimizing logistics for seamless operations. From customs clearance to freight management, we streamline your entire supply chain.",
    ...
    },
    {
      ...
      description:
        "Our AEO certification offers significant benefits, including faster customs clearance, reduced inspections, and priority treatment. Maximize efficiency and minimize delays with our trusted AEO status.",
  ...
  return (
    <>
      <section className="pb-5 pt-20 lg:pb-10 mt-5 bg-mylight">
