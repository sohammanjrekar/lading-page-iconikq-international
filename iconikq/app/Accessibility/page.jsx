...
export const metadata = {
  ...
  description:
    "Learn about our commitment to accessibility and the measures we take to ensure our services are accessible to everyone.",
  ...
  return (
    <div className="p-6 mt-24 max-w-[80vw] mx-auto text-gray-800">
      <h2 className="text-3xl font-bold border-b-4 border-blue-600 pb-3">
        ...
        <span className="text-blue-600">Iconikq International</span>
      </h2>
      ...
      <p className="text-base mt-4">
        ...
        is <span className="font-bold text-green-600">fully conformant</span>{" "}
        with{" "}
        <span className="font-semibold text-blue-600">WCAG 2.1 level AA</span>.
        This means that the content fully conforms to the accessibility standard
      ...
      <ul className="list-none mt-6 space-y-3">
        ...
        <li>
          ...
          <span className="text-blue-600">
            704/705, Filix, Opposite Asian Paints, LBS Marg, Bhandup West,
            Mumbai – 400078
          </span>
        </li>
      </ul>
