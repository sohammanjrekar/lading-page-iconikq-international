    ...
    <p class="block antialiased font-sans  leading-relaxed text-inherit mb-8 text-xl font-normal !text-gray-500">Manage ICONIKQ&apos;s logistics services, content, and client data efficiently with the Admin Dashboard</p>
        ...
        <div className="mt-12">
          ...
          <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="relative h-[20vh] flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            ...
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white h-[20vh] text-gray-700 shadow-md">
